package com.YeongJin.jdbc.template;
...
import com.YeongJin.jdbc.raw.Article;
import com.YeongJin.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/YeongJinDB?user=yeongjin&password=dudwlsdl153");
